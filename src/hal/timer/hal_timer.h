...
typedef struct
{
    TIM_TypeDef* pTimer;       /**< Base address of the timer peripheral */
 ...
 * @param[in] pTimer pointer to the base address of the timer peripheral.
 ...
 * @return void.
 */
void Timer_ApplicationEventCallback(TIM_TypeDef* pTimer, Timer_Event_t timer_event);
